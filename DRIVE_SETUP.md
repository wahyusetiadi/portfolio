...
Untuk menghapus gambar yang tersimpan, klik **Hapus gambar** di bawah pratinjau. Perubahan referensi portfolio langsung tersimpan; file yang diunggah melalui aplikasi dipindahkan ke **Sampah** Google Drive. Mengosongkan URL secara manual hanya melepas referensi saat **Simpan Perubahan** diklik dan tidak menghapus file di Drive. Jika URL social preview kosong, metadata halaman tidak memakai gambar bawaan.
